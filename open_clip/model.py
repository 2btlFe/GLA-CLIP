...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, external_feats, beta, gamma, normalize: bool = False, 
                    indices=None, model_cfg=None):

        features = self.visual(image, external_feats, beta, gamma, indices=indices, model_cfg=model_cfg)
